...
///////////////////////////////////////////////////////////////////////////////
//
//  prism_graphic_text.h - Prism graphical text widget
//
...
#ifndef _PRISM_GRAPHIC_TEXT_
#define _PRISM_GRAPHIC_TEXT_

BEGIN_NAMESPACE_PRISM

///////////////////////////////////////////////////////////////////////////////
class Pm_Graphic_Text : public Pm_Text_Output
{
    public:

        Pm_Graphic_Text(const Pm_Region &Size,
                        pm_int_t StringId = 0, uint16_t Id = 0,
                        uint32_t Style = PM_BORDER_NONE|PM_JUSTIFY_LEFT|
                                         PM_PAINT_TRANS|PM_ANIM_ALWAYS);
